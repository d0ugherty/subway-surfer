...
urlpatterns = [
    ...
    path('init_nta/', views.init_next_to_arrive, name='init_nta'),
    path('next_to_arrive/<str:station>/', views.load_next_to_arrive, name='next_to_arrive'),
    path('update_next_to_arrive/', views.update_next_to_arrive, name ='update_next_to_arrive'),
